...
urlpatterns = [
    ...
    url(r'^dj-admin/editar_entradas/(?P<pk>[\w-]+)/$', Editar_Entradas.as_view(model=Entrada), name='Editar_Entradas'),
    ...
    url(r'^dj-admin/paginas/$', Paginas.as_view(), name='Paginas'),
    url(r'^dj-admin/agregar_paginas/$', agregar_paginas.as_view(), name='Agregar_p'),
    url(r'^dj-admin/editar_paginas/(?P<pk>[\w-]+)/$', Editar_Paginas.as_view(model=Pagina), name='Editar_Paginas'),
    url(r'^dj-admin/eliminar_paginas/$', Eliminar_Paginas,
        name='Eliminar_Paginas'),
